...
urlpatterns = [
    ...
    path('products/<uuid:pk>/similar/',        views.get_similar_products,  name='product-similar'),
    ...
    path('orders/<uuid:pk>/change-delivery-zone/', views.change_delivery_zone, name='order-change-delivery-zone'),
